...
1. A container image that exposes a memory-lock endpoint and CPU information endpoint for attacker instances.
2. Scripts that:
...
2. Deploy many instances of this image as attacker functions/services (e.g., Lambda, Function Apps, Cloud Run).
